...
export const FormKeunggulan = ({ id, modalRef }) => {
  const api = import.meta.env.VITE_API;
  const token = localStorage.getItem("token");

  const { data: detail } = FetchData({ url: `${api}/admin/services`, token });
  ...
  return (
    <ModalWrapper title={`${id ? "Edit" : "Tambah"} Keunggulan`} modalRef={modalRef}>
      <form
