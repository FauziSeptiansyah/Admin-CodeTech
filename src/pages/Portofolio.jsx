...
import { FormPortofolio } from "./form/FormPortofolio";
...
export const Portfolio = () => {
  ...
  const handleDelete = async (id) => {
    return axios.delete(`${api}/admin/portfolios/${id}`, {
      ...
      {loading ? (
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="mb-6 border-b pb-4">
            <h1 className="text-2xl font-semibold text-gray-800">Portofolio</h1>
            <nav className="mt-2">
              <ol className="flex text-sm text-gray-500 space-x-2">
                ...
                <li>/</li>
                <li className="text-gray-700 font-medium">Portofolio</li>
              </ol>
            </nav>
          </div>
          ...
          <FormPortofolio id={selectedId} modalRef={modalRef} />
        </div>
      )}
    </Layout>
  );
