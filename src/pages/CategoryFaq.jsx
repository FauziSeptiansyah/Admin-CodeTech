...
import { FormCategoryFaq } from "./form/FormCategoryFaq";
...
export const CategoryFaq = () => {
  ...
  const handleDelete = async (id) => {
    return axios.delete(`${api}/admin/category-faqs/${id}`, {
    ...
    <Layout>
      {loading ? (
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="mb-6 border-b pb-4">
            ...
            <nav className="mt-2">
              <ol className="flex text-sm text-gray-500 space-x-2">
                ...
                <li>/</li>
                <li className="text-gray-700 font-medium">Kategori</li>
              </ol>
            </nav>
          </div>
          ...
          <FormCategoryFaq id={selectedId} modalRef={modalRef} />
        </div>
      )}
    </Layout>
  );
